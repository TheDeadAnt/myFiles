__kernel void HelloWorld(__global int* argument1, __global int* argument2, __global int* output){
	...
	*/
	...
	if (workItemNum==0){
	for(int i=0; i<4; i++){
		groupValue = groupValue +output[i];
		}
	...
	//printf ("groupValue: %d        Work Item: %-2d    Work Group: %d \n",output0,workItem0,workGroup0);
	//printf ("groupValue: %d        Work Item: %-2d    Work Group: %d \n",output1,workItem1,workGroup1);
	//printf ("groupValue: %d        Work Item: %-2d    Work Group: %d \n",output2,workItem2,workGroup2);
	//printf ("groupValue: %d        Work Item: %-2d    Work Group: %d \n",output3,workItem3,workGroup3);
